...
% Modern bibliography facilities (you may change style to numeric). Change to old bibtex if you insist on using that.
...
\addbibresource{thesis.bib} % New command, use if available
...
% \paper{\citefield{paper:A}{GPU}}{\fullcite{paper:A}}
% \includepdf[pages=-,width=\paperwidth]{./papers/dccpaper_obsidian.pdf}

\paper{\citefield{ifl}{title}}{\fullcite{ifl}} 
\includepdf[pages=-,width=\paperwidth]{./papers/obsidian_ifl2008.pdf}

\paper{\citefield{procedia}{title}}{\fullcite{procedia}} 
\includepdf[pages=-,width=\paperwidth]{./papers/procedia.pdf}

\paper{\citefield{expressive}{title}}{\fullcite{expressive}} 
\includepdf[pages=-,width=\paperwidth]{./papers/expressive.pdf}

\paper{\citefield{csort}{title}}{\fullcite{csort}} 
\includepdf[pages=-,width=\paperwidth]{./papers/csort.pdf}

\paper{\citefield{bb}{title}}{\fullcite{bb}} 
\includepdf[pages=-,width=\paperwidth]{./papers/bb.pdf}

\paper{\citefield{faspp}{title}}{\fullcite{faspp}} 
\includepdf[pages=-,width=\paperwidth]{./papers/faspp2011_haskell_arbb.pdf}

\paper{\citefield{almost}{title}}{\fullcite{almost}} 
\includepdf[pages=-,width=\paperwidth]{./papers/almost_free.pdf}
%\includepdf[pages=-,width=\paperwidth]{./papers/csort.pdf}
