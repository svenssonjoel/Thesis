...
\node [wbox,inner ysep=19.5pt,right=0cm of gd.north east, anchor=north west] (obs1) {% 
  \begin{minipage}{0.35\linewidth}
        {\small pMap, generate, DPush, DPull}
    \end{minipage}
};

\node [wbox,inner ysep=14pt,below=0pt of obs1.south] (obs2) {% 
  \begin{minipage}{0.35\linewidth}
        {\small pMap, generate, force, SPush, SPull}
    \end{minipage}
};
%below=0cm of obs2.south
\node [wbox,inner ysep=13.5pt, below=0pt of obs2.south] (obs3) {% 
  \begin{minipage}{0.35\linewidth}
...
exposed by Obsidian. In reference ~\citehl{JOSEFJOELCSORT} we make use of the low-level 
