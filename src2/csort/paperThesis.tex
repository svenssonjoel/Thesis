...
\input{./csort/intro.tex}
\input{./csort/Algorithm.tex}
\input{./csort/GPUs.tex}
\input{./csort/Obsidian.tex} 
\input{./csort/ObsCudaAlgo.tex}
\input{./csort/benchmarks.tex}
\input{./csort/discussion.tex}
