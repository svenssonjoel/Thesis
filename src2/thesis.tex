...
Shared memory could also be used to coalesce reads from global memory. Shared memory is 
...
causes the execution path diverge within a warp will affect performance. When the execution 
...
Failing to ensure this will likely lead to the kernel producing incorrect answers. Note that 
