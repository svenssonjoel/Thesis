...
the permutation used will decide the access pattern. If global memory accesses can 
be coalesced or not partly also depends on the algorithm being implemented. 
...
a limited resource in the MP, so if a kernel uses very much shared memory, 
