...
non-graphics applications via the graphics API. The computation needed to be expressed 
in graphics terms and the result computed through an act of rendering. Of course, since the 
available abstractions targetted at the graphics domain, this added extra
burden  on the programmer. CUDA was NVIDIA's first response to this problem. With CUDA 
there is a dialect of C, extended with GPU specific functionality. 
...
think about hardware specific details to get the best performance. This CUDA provides, 
