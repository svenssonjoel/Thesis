...
data-parallelism. Graphics processors (GPUs) brings massive parallelism at the cost of 
...
Each generation of CPU and GPU bringing more parallel resources. The question of how to write 
programs for these processors efficiently arise. We are after efficiency both in programmer 
...
can implement these primitives in different ways, select the best one and then  abstract 
upon that. We have obtained very good performance in case studies involving reductions. 
...
and tips he has provided over he years. I cannot imagine that this would have worked with 
any other supervisors. Thanks to Josef Svenningsson, a late addition to my troop of 
supervisors. Working with Josef has been a very fun and rewarding experience. 
