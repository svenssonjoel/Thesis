...
we only study scan kernels (scan of small arrays) and measure their speed relative to eachother. 
Compared to a scan kernel supplied with the CUDA API, our kernel fastest kernel is slighty more 
...
a reduction kernel in Obsidian. At the end, the implemented reduction kernel 
reaches a throughput of 140GB/sec on a GPU with 192GB/sec memory bandwith. 
