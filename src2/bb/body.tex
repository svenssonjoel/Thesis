...
\begin{minipage}[]{0.45\columnwidth}
\includegraphics[width=\columnwidth]{./bb/spiral1}
\end{minipage}
&
\begin{minipage}[]{0.45\columnwidth}
\begin{small}
...
\hspace{0.05\columnwidth}
\begin{minipage}[]{0.45\columnwidth}
\includegraphics[width=\columnwidth]{./bb/wall2}
\end{minipage}
...
\section{Meeting in \docname{}'s office} %\section{Related Work} 
...
it works. For example, in this paper \direct{\docname{} shows
  \studname{} the paper \cite{Generic}}, the authors use a
...
described in a separate paper \direct{\docname{} pulls out the paper
  \cite{axelsson2012generic} from a pile of papers}. It's hard to do
...
\section{Composing reifiable monadic languages} 
\label{sec:composing} 
...
purpose GPU programming \cite{Obsidian}. Obsidian has language
