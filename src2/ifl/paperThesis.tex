...
%\end{abstract}
\input{./ifl/intro}
\input{./ifl/combinators}   %% uncomment when file available
\input{./ifl/GPUs}           %% I decided to put a separate section on GPUs, rather
                       %% than trying to cover it in the intro.

\input{./ifl/obsidian}
\input{./ifl/results}
\input{./ifl/related}
\input{./ifl/futurework}
\input{./ifl/conclusion}


\bibliographystyleifl{alpha}
\bibliographyifl{thesis}
